...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { create: @friendship.create, destroy: @friendship.destroy, user_id: @friendship.user_id }
    end
  ...
  test "should update friendship" do
    patch :update, id: @friendship, friendship: { create: @friendship.create, destroy: @friendship.destroy, user_id: @friendship.user_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
